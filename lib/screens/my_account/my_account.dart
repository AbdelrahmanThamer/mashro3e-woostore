...
class MyAccountScreenLayout extends StatelessWidget {
  const MyAccountScreenLayout({
    Key? key,
    required this.screenData,
  }) : super(key: key);
  final AppMyAccountScreenData screenData;
      ...
      body: CustomScrollView(
        slivers: [
          if (screenData.appBarData.show)
            SliverAppBarLayout(
              overrideTitle: S.of(context).account,
