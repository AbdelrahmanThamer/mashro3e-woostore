...
class _SameAsBillingAddress extends StatelessWidget {
  const _SameAsBillingAddress({Key key}) : super(key: key);
                  ...
                  children: <Widget>[
                    ...
                    DropdownSearch<WooCountry>(
                      ...
                      popupProps: const PopupProps.dialog(
                        dialogProps:
                            DialogProps(barrierColor: Color(0x50000000)),
                        showSearchBox: true,
                      ),
