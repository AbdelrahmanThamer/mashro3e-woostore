...
class VendorProductsSortBottomSheet extends StatelessWidget {
  const VendorProductsSortBottomSheet({
    Key? key,
...
class _Item extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Selector<VendorProductsViewModel, WooStoreFilters>(
      ...
      builder: (context, filters, _) {
        return GestureDetector(
          onTap: () {
            ...
            final provider = Provider.of<VendorProductsViewModel>(
              context,
              listen: false,
            );
