...
class CategoryProductsListContainer extends ConsumerWidget {
  const CategoryProductsListContainer({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return legacy.Selector<CategoryProductsProvider,
