...
import '../../../locator.dart';
import '../../../services/woocommerce/enums/sort_option.dart';
...
class CategorySortBottomSheet extends StatelessWidget {
  const CategorySortBottomSheet({Key? key}) : super(key: key);
...
class _Item extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Selector<CategoryProductsProvider, WooStoreFilters>(
      selector: (context, d) => d.categoryFilters,
      builder: (context, filters, _) {
        return GestureDetector(
          onTap: () {
            ...
            LocatorService.categoryProductsProvider().setSortOption(sortOption);
            NavigationController.navigator.pop();
            LocatorService.categoryProductsProvider().fetchWithSortOption();
          },
          child: Container(
