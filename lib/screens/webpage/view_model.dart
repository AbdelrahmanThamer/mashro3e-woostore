...
class WebpageScreenLayoutViewModel with ChangeNotifier {
  WebpageScreenLayoutViewModel(this.initialUrl)
  ...
  Future<void> onPageFinished(String url) async {
    ...
    if (uri?.queryParameters.containsKey('woostore_pro_product_id') ?? false) {
