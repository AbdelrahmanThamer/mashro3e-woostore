...
class SocialLoginData {
  ...
  const SocialLoginData({
    ...
    this.enableSmsLogin = true,
    this.defaultCountryCode = kDefaultCountryCode,
  });
  ...
  factory SocialLoginData.fromMap(Map<String, dynamic>? map) {
    if (map == null) {
      return const SocialLoginData();
    }
    return SocialLoginData(
      enableAppleLogin: ModelUtils.createBoolProperty(map['enableAppleLogin']),
      enableGoogleLogin: ModelUtils.createBoolProperty(
        map['enableGoogleLogin'],
      ),
      enableFacebookLogin: ModelUtils.createBoolProperty(
        map['enableFacebookLogin'],
      ),
      enableSmsLogin: ModelUtils.createBoolProperty(map['enableSmsLogin']),
      defaultCountryCode: ModelUtils.createStringProperty(
        map['defaultCountryCode'],
        kDefaultCountryCode,
      ),
    );
  }

  SocialLoginData copyWith({
    ...
    return SocialLoginData(
      ...
      enableSmsLogin: enableSmsLogin ?? this.enableSmsLogin,
